        ...
        <div className="relative hidden w-1/2 flex-col justify-between border-r border-white/10 bg-gradient-to-br from-violet-950/80 via-black to-cyan-950/40 p-12 lg:flex">
          <AnimateIn direction="right">
            <Link href="/" className="flex items-center gap-2.5">
              <div className="auth-logo-3d flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-violet-600 to-cyan-500 text-sm font-bold">
                W
              </div>
            ...
            <div>
              ...
              <ul className="mt-8 space-y-3 text-sm text-white/50">
                {[
                  ...
                  <li key={item} className="flex items-center gap-2 animate-fade-up" style={{ animationDelay: `${200 + i * 80}ms` }}>
